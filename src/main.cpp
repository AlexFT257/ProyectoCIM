...
#define RX_PIN 17  // Pin RX serial que debe conectarse al TX del SIM808, se utiliza para configurar la variable "mySerial"
#define TX_PIN 16  // Pin TX serial que debe conectarse al RX del SIM808, se utiliza para configurar la variable "mySerial"
